...
func NewToriReplayScene() *Scene {
	...
	w.AddAreaLight(shapes.NewAreaLight(geom.NewPoint(0, wallDistance*0.8, 0), geom.NewVector(15, 0, 0), 2, geom.NewVector(0, 0, 15), 2, colors.NewColorFromHex("ffffd7").MulBy(6), nil))
